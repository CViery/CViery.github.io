...
function pesquisarProdutos(termo) {
  ...
  const carrinho = {
    ...
    atualizar: function() {
        let carrinhoHtml = gerarHtmlCarrinho();
  ...
  function gerarHtmlCarrinho() {
    ...
    for (var i = 0; i < carrinho.produtos.length; i++) {
      html += '<div class="carrinho">';
      html += '<h2>' + carrinho.produtos[i].nome + '</h2>';
      html += '<p>' + carrinho.produtos[i].codigo + '</p>';
      html += '<p>Quantidade: ' + carrinho.produtos[i].quantidade + '</p>';
      html += '<button onclick="removerDoCarrinho(' + i + ')">Remover do carrinho</button>';
      html += '</div>';
    }
    return html;
  }